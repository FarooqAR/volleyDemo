...
public class MovieSearchFragment extends Fragment {
    ...
    private String tag_json_obj = "json_movie_search_request";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rv.addOnChildAttachStateChangeListener(new RecyclerView.OnChildAttachStateChangeListener() {
            ...
            public void onChildViewAttachedToWindow(View view) {
                ...
                String v2 = movies.get(layoutManager.getItemCount() - 1).title;
/*
                if (v1.getText().equals(v2)) {

                    sendRequest(nextUrl+"&apikey="+AppController.API_KEY);
                }*/
            }
...
//                            Log.d(TAG, "" + movieJSONArray);
                            ...
                            movieListAdapter.notifyItemRangeInserted(movies.size(), page_limit);
